...
/**
 * Clase encargada de ajustar el estado de la partida cuando se realiza un movimiento.
 * @author alfonsofelix
 */
            ...
            if (partida.getJugadorTurno() != null && partida.getEstado() == EstadoPartida.INICIADA && partida.getCuantasMueve() > 0) {
                ...
                if (jugadorTurno.isMeterFicha()) {
                    ...
                    if (casillaActual != null) {
                        ...
                        if (destino != null) {
                            if (!(destino instanceof CasillaCentro)) {
                                if (destino.getFicha() == null) {
                                    ...
                                    if (!debeMeter) {
                                        ...
                                        if (!(destino instanceof CasillaSemicirculo)) {

                                            if (destino instanceof CasillaTriangulo) {
